...
public class SelectCategoryFragment extends Fragment implements SelectCategoryAdapter.ItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        searchText = view.findViewById(R.id.search3_search_text);
        addTextWatcher();
        createRecycler(view);
        return view;
    }
    ...
    private void createRecycler(View view) {
        mRecyclerView = view.findViewById(R.id.search3_recycler_view);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(getActivity());
        mRecyclerView.setLayoutManager(mLayoutManager);

        List<LocationCategory> list = locationCategoryData.getList();
        mAdapter = new SelectCategoryAdapter(getActivity(), newList());
