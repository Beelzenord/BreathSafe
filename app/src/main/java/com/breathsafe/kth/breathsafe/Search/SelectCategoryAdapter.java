...
public class SelectCategoryAdapter extends RecyclerView.Adapter<SelectCategoryAdapter.MyViewHolder> {
    ...
    private SelectCategoryAdapter.ItemClickListener mClickListener;

    public SelectCategoryAdapter(Activity Activity, List<LocationCategory> myDataset) {
    ...
    @NonNull
    @Override
    public SelectCategoryAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = (View) LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_in_recycler, viewGroup, false);

        SelectCategoryAdapter.MyViewHolder vh = new SelectCategoryAdapter.MyViewHolder(v);
...
//        vh.district = v.findViewById(R.id.district);
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull SelectCategoryAdapter.MyViewHolder myViewHolder, int i) {
        try {
